...
```{r}
spdata <- read_csv("COVID-19_Singapore - singapore_ncov_2019_fix.csv")
...
pdata <- data.frame(days=spdays,  fitsurv=1-pweibull(spdays, shape = exp(spfit$coefficients[1]),
scale = exp(spfit$coefficients[2])))
