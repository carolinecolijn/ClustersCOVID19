...
Late median 12.11 shape  7.78 (9.52, 21.47) scale 0.695 (0.379,0.778)

Serial interval: 4.31 with sigma = 0.934 (w 4 cases per cluster) 
...
median 8.06 shape 4.74 (3.35, 5.72) scale 1.827 (1.285, 2.045)
 ...
 median 12.11 shape 7.78 (9.52, 21.47) scale 0.695 (0.379,0.778)
...
NEXT TASK: re-read what we did before; make the above plot again maybe as a data frame and produce something for the paper. Then copy it to the Singapore file and do the same there. Do this in the context of what is in the paper now so that it will fit. 
