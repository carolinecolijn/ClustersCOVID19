...
JS: I HAVE UPDATED THIS SECTION FOR NEW DATA TOO
...
Step 1: All end_source entries are already complete, but the some of the imputed symptom onset individuals don't have a start_source. We use the same rules as with the non-imputed dataset with the imputed symptom onsets, and set the start source as the symptom onset - 20 in the absence of other data.

```{r}
### Start source column
imp_data$start_source[is.na(imp_data$start_source)] = imp_data$dso_imputed[is.na(imp_data$start_source)]-20 
