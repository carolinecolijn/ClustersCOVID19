...
**The 95% range for the mean serial interval with imputed dates of symptom onset is (`r myest4_i[1]-1.96*sd(bestimates_i[,1])`, `r myest4_i[1]+1.96*sd(bestimates_i[,1])`). This is using imputed date of symptom onset and estimated with 4 cases per cluster.**
