...
#Write to PDF
pdf("Singapore incidence by source of infection.pdf", 
     #family = "Times", 
     width = 8, height = 6)
...
#Write to PDF
pdf("Tianjin incidence by source of infection.pdf", 
     #family = "Times", 
     width = 8, height = 6)

t.cols <- c("Known relationship" = "#000004FF",  #Use the same as Singapore plot, as are using the same criteria
            "Wuhan origin" = "#280B54FF",   #Use the same as Singapore plot, as are using the same criteria
