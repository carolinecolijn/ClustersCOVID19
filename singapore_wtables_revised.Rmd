...
#ggsave(file = "final_figures/FigS1_bootst_SI_early_wuhan_sing.pdf", width = 6, height = 4)
```
...
#ggsave(file = "final_figures/FigS1_bootst_SI_early_sing.pdf", width = 6, height = 4)
```
