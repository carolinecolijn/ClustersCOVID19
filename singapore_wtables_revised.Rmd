...
(method1 <- sum(!is.na(spdata$end_source))) #20 cases can have date of last possible exposure estimated by this method
...
range(earlydata$last_poss_exposure, na.rm = T)  #Dates range from 
...
# earlynew <- filter(spdata, date_onset_symptoms <= as.Date("2020-01-31")) #38 cases
# latenew <- filter(spdata, date_onset_symptoms > as.Date("2020-01-31")) #43 cases
