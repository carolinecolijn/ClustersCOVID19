...
#Note that the order the data are selected in is VERY important to which case goes into which source_group category
  #For those that meet multiple criteria (e.g. wuhan; tj1), the str_match which is highest in the case_when call (i.e. "wuhan" or "hubei") will have priority over those matching later 
  ...
  #TODO: change this order in the MANUSCRIPT METHODS

t.data <- mutate(t.data, source_group = case_when(!is.na(str_match(Infection_source, "wuhan|hubei")) ~ "Wuhan origin",
